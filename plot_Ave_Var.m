% This function is used to accept input "A" and out two plots (Average and Variance of x, y, and z coordinate at each time interval). Just Use command line "Plot_Ave_Var" in the main script to call this function
